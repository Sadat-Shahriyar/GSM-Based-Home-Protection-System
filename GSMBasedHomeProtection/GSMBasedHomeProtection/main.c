...
//
//
//#define DEFAULT_RESPONSE_SIZE 1200
...
char ATcommand[] = {'A', 'T', '\n\r', '\0'};
char ATDcommand[] = {'A', 'T', 'D', '+', '8', '8', '0', '1', '7','8','9', '9', '9', '1', '6', '6', '7', ';', '\n\r', '\0'};
char ATHcommand[] = {'A', 'T','H', '\n\r', '\0'};
char setBaudRate[] = {'A', 'T', '+', 'I', 'P', 'R', '=', '9', '6', '0', '0', '\n\r','\0'};
char ATCMGFcommand[] = {'A', 'T', '+', 'C', 'M', 'G', 'F', '=', '1','\n\r','\0'};
char ATCMGScommand[] = {'A', 'T', '+', 'C', 'M', 'G', 'S', '=', '"', '+', '8', '8', '0', '1', '7','8','9', '9', '9', '1', '6', '6', '7', '"', '\n\r', '\0'};
...
int getPirTime(){
	int timeCount = (pirTimeCount*65536+TCNT1)/(60*1000000);
	if(toggle == 1)
	return timeCount;
	else return 0;
}
...
void getGasSensorInput(){
	...
	if(lpgAmount < 0) lpgAmount = 65535;
	lpg2 = lpgAmount;
